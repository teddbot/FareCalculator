...
function initmap() {	//creates the map
	...
	var DKLatLng = createLatLng(0.347596, 32.582520);   //Kampala coordinates
...
function dirOnHead(routeIndex) {
    ...
    var start = 10000.00;  //Starting fare for taxi
    var p100m = 100;    //Price for each 100m in Danish Krone
